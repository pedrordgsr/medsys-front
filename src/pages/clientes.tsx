                        ...
                        <form onSubmit={onSubmit} className="flex flex-col gap-4" noValidate>
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <input
                                    ...
                                    onChange={onChange}
                                    className={`border rounded-md px-3 py-2 text-sm outline-none focus:ring-2 ${form.cpf && form.cpf.length === 11 && !validarCPF(form.cpf) ? 'border-red-500 focus:ring-red-400' : 'focus:ring-stone-400'}`}
                                    ...
                                    pattern="[0-9]*"
                                />
                                {form.cpf && form.cpf.length === 11 && !validarCPF(form.cpf) && (
